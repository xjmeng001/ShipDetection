...
with open(results_files_path + "/results.txt", 'w') as results_file:
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        if draw_plot:
            ...
            plt.plot(score, F1, "-o", color='orangered', markersize=2)
            plt.title(F1_text + "\nscore_threhold=0.5")
            ...
            plt.plot(score, rec, "-o", color='g', markersize=2)
            ...
            plt.plot(score, prec, "-s", color='m', markersize=2)
            plt.title(Precision_text + "\nscore_threhold=0.5")
            plt.xlabel('Score_Threhold')
            plt.ylabel('Precision')
            axes = plt.gca()  # gca - get current axes
            axes.set_xlim([0.0, 1.0])
