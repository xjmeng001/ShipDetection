...
from utils.box_utils import (decode, letterbox_image,
                             non_max_suppression, retinaface_correct_boxes)
from utils.config import cfg_mnet, cfg_re50


def preprocess_input(image):
    image -= np.array((52, 77, 81),np.float32)
    return image
...
class Retinaface(object):
    _defaults = {
        "model_path"        : 'model_data/Epoch114-Total_Loss0.3237-Conf_Loss.pth0.0999-Regression_Loss0.2241.pth',
        "backbone"          : 'resnet50',
        "confidence"        : 0.9,
        "nms_iou"           : 0.45,
        "cuda"              : True,
